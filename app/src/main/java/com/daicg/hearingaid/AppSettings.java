...
final class AppSettings {
    ...
    static final String KEY_PHONE_MIC_INPUT = "phone_mic_input";
    ...
    static boolean phoneMicInputEnabled(Context context) {
        return prefs(context).getBoolean(KEY_PHONE_MIC_INPUT, true);
    }
